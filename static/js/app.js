...
var App = function () {
    ...
    var touchSession = function(){
    	touchSessioninterval=setInterval(function(){
    		console.log("touch");
    		$.get("/touch?t="+(new Date()).getTime());
    	},3000);
    }  
...
$(function(){
	jQuery.extend(jQuery.validator.messages, {
		...
		maxlength: jQuery.format("长度最多 {0} 个字"),
		minlength: jQuery.format("长度最少 {0} 个字"),
		rangelength: jQuery.format("长度介于 {0} 到 {1} 之间"),
